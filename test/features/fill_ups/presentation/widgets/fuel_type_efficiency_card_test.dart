...
void main() {
  ...
  FuelTypeEfficiencyStats pure({
    ...
    double? l100,
    double? costPerKm,
    double recordedPurchaseSpend = 0,
    int fillCount = 0,
    int attributed = 0,
  }) =>
      FuelTypeEfficiencyStats(
        ...
        recordedPurchaseSpend: recordedPurchaseSpend,
        fillCount: fillCount,
  ...
  testWidgets(
    ...
    (tester) async {
      await pumpCard(
        ...
        vehicle: flexCar,
        data: [
          pure(fuel: FuelType.e85, recordedPurchaseSpend: 115, fillCount: 3, attributed: 2),
          pure(fuel: FuelType.e10, recordedPurchaseSpend: 178.5, fillCount: 3,
              attributed: 2),
        ],
      );
  ...
  testWidgets(
    ...
    (tester) async {
      await pumpCard(
        ...
        vehicle: flexCar,
        data: [
          pure(fuel: FuelType.e85, recordedPurchaseSpend: 100, fillCount: 3, attributed: 2),
          pure(fuel: FuelType.e10, recordedPurchaseSpend: 120, fillCount: 3, attributed: 2),
        ],
      );
      expect(find.byKey(const ValueKey('fuel_efficiency_winner_chip')),
          findsNothing);
  ...
  testWidgets('never throws on legacy/all fuel + zero data shape',
    ...
    await pumpCard(
      ...
      vehicle: flexCar,
      data: [
        pure(fuel: FuelType.all, recordedPurchaseSpend: 10, fillCount: 1),
        pure(fuel: FuelType.e10, recordedPurchaseSpend: 20, fillCount: 1),
      ],
    );
    expect(tester.takeException(), isNull);
    expect(find.byKey(const ValueKey('fuel_type_efficiency_card')),
