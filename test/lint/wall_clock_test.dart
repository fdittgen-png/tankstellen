...
void main() {
  ...
  const baseline = <String, int>{
    ...
    'lib/features/receipts_ocr/data/ocr/ocr_trace_recorder.dart': 1,
    'lib/features/receipts_ocr/data/ocr/receipt_pdf_rasterizer.dart': 1,
    'lib/features/trips/domain/entities/gps_sample_diagnostic.dart': 1,
    'lib/features/trips/domain/services/gps_matrix_reconciler.dart': 1,
    ...
    'lib/features/obd2/data/session/auto_trip_coordinator.dart': 1,
    'lib/features/obd2/domain/broken_map_belief_updater.dart': 1,
    'lib/features/obd2/domain/broken_map_detector.dart': 1,
    'lib/features/obd2/data/transport/classic_elm_channel.dart': 2,
    'lib/features/obd2/data/transport/fake_background_adapter_listener.dart': 3,
    ...
    'lib/features/obd2/data/session/obd2_self_test_steps.dart': 4,
    ...
    'test/features/trips/comm_health_per_trip_test.dart': 1,
    'test/features/trips/data/baseline_store_test.dart': 1,
    'test/features/trips/data/ghost_trip_dedup_test.dart': 1,
    'test/features/trips/data/trip_history_repository_test.dart': 1,
    'test/features/trips/presentation/screens/trip_recording_screen_unpinned_warning_test.dart': 5,
    'test/features/trips/presentation/widgets/trip_verdict_prompt_card_test.dart': 1,
    'test/features/trips/providers/gps_only_backgrounding_flush_test.dart': 1,
    'test/features/trips/providers/gps_only_imu_fusion_test.dart': 3,
    'test/features/trips/providers/gps_only_recording_pipeline_test.dart': 1,
    'test/features/trips/providers/gps_only_trip_wal_test.dart': 1,
    'test/features/trips/providers/maintenance_provider_test.dart': 2,
    'test/features/trips/providers/trip_recording_gps_diagnostics_persistence_test.dart': 1,
    'test/features/trips/providers/trip_recording_lifecycle_marks_test.dart': 2,
    'test/features/trips/providers/trip_recording_provider_active_snapshot_test.dart': 3,
    'test/features/trips/providers/trip_recording_provider_automatic_flag_test.dart': 3,
    'test/features/trips/providers/trip_recording_provider_gps_test.dart': 1,
    'test/features/trips/providers/trip_recording_samples_persistence_test.dart': 1,
