...
void main() {
  ...
  const grandfathered = <String>{
    ...
    'lib/features/consumption/data/obd2/broken_map_detector.dart',
    'lib/features/consumption/data/obd2/obd2_cache_openers.dart',
    'lib/features/consumption/data/obd2/obd2_service.dart',
    'lib/features/consumption/data/obd2/reconnect_connector.dart',
