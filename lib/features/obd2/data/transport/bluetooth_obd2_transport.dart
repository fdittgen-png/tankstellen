...
part 'bluetooth_obd2_transport_open_retry.dart';
...
class BluetoothObd2Transport
  ...
  Future<void> connect() async {
    ...
    _frame.clear();
    // #2906 — bounded channel-open retry + backoff; the loop body lives in
    // [_openChannelWithRetry] (same library part, #3760 move-only).
    await _openChannelWithRetry(_channel);
