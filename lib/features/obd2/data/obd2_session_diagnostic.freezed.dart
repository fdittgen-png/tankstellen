...
@JsonKey(name: 'frm') Obd2FramingStats get framing;/// Frames that ARRIVED but decoded outside their plausible bounds
...
@JsonKey(name: 'imp') Map<String, int> get implausibleFrames;/// Per-tick fuel-resolution-tier distribution: branch tag → tick
...
as Obd2FramingStats,implausibleFrames: null == implausibleFrames ? _self.implausibleFrames : implausibleFrames // ignore: cast_nullable_to_non_nullable
as Map<String, int>,fuelTierTicks: null == fuelTierTicks ? _self.fuelTierTicks : fuelTierTicks // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Obd2SessionDiagnostic() when $default != null:
return $default(_that.linkKind,_that.redactedMac,_that.elmVersion,_that.protocolDigit,_that.mtu,_that.warmStart,_that.capabilityTier,_that.initTranscript,_that.pidStats,_that.connection,_that.reconnectAttempts,_that.transitions,_that.fallbackActivatedAtMs,_that.disconnectExceptions,_that.scheduler,_that.framing,_that.implausibleFrames,_that.fuelTierTicks,_that.fuelDowngrade,_that.sessionActiveSeconds,_that.discoveredSupported,_that.expectedReads,_that.achievedReads,_that.completenessPercent,_that.completeness);case _:
  return orElse();
...
/// apart from the fuel breadcrumbs, whose suspicious tally feeds
/// `fuelRateSuspect`. Bounded by the small enum.
 final  Map<String, int> _implausibleFrames;
/// Frames that ARRIVED but decoded outside their plausible bounds
/// (#4325), keyed by `ImplausibleFrameKind.name` (`'batteryVoltage'`,
/// `'odometer'`). Consumers received null for these exactly as for
/// NO DATA; this keeps the adapter/ECU fault behind them visible. Kept
/// apart from the fuel breadcrumbs, whose suspicious tally feeds
/// `fuelRateSuspect`. Bounded by the small enum.
@override@JsonKey(name: 'imp') Map<String, int> get implausibleFrames {
  if (_implausibleFrames is EqualUnmodifiableMapView) return _implausibleFrames;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_implausibleFrames);
}
...
as int,scheduler: null == scheduler ? _self.scheduler : scheduler // ignore: cast_nullable_to_non_nullable
as Obd2SchedulerStats,framing: null == framing ? _self.framing : framing // ignore: cast_nullable_to_non_nullable
as Obd2FramingStats,implausibleFrames: null == implausibleFrames ? _self._implausibleFrames : implausibleFrames // ignore: cast_nullable_to_non_nullable
as Map<String, int>,fuelTierTicks: null == fuelTierTicks ? _self._fuelTierTicks : fuelTierTicks // ignore: cast_nullable_to_non_nullable
as Map<String, int>,fuelDowngrade: null == fuelDowngrade ? _self.fuelDowngrade : fuelDowngrade // ignore: cast_nullable_to_non_nullable
as Obd2FuelDowngradeStats,sessionActiveSeconds: null == sessionActiveSeconds ? _self.sessionActiveSeconds : sessionActiveSeconds // ignore: cast_nullable_to_non_nullable
