...
/// half-done #3136): pump-display OCR capture, receipt parsing
/// (spatial + brand-layout + e-receipt), the shared-receipt intent
/// pipeline and the bad-scan reporting surfaces.
///
...
export 'data/pump_scan_disposition.dart';
...
export 'presentation/widgets/pump_scan_failure_sheet.dart';
