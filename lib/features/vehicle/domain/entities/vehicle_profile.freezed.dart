...
//     samples.
 int? get engineDisplacementCc; int? get engineCylinders; double get volumetricEfficiency; int get volumetricEfficiencySamples;// User-editable calibration overrides (#1397). Each is null until
...
/// only consulted when the trajet's `obd2CoverageRatio < 0.95`.
 GpsCalibrationMatrix? get gpsCalibration;
...
@useResult
$Res call({
 String id, String name,@VehicleTypeJsonConverter() VehicleType type, double? batteryKwh, double? maxChargingKw,@ConnectorTypeSetConverter() Set<ConnectorType> supportedConnectors,@ChargingPreferencesJsonConverter() ChargingPreferences chargingPreferences, double? tankCapacityL, String? preferredFuelType, int? engineDisplacementCc, int? engineCylinders, double volumetricEfficiency, int volumetricEfficiencySamples, double? manualEngineDisplacementCcOverride, double? manualVolumetricEfficiencyOverride, double? manualAfrOverride, double? manualFuelDensityGPerLOverride, int? curbWeightKg, String? obd2AdapterMac, String? obd2AdapterName, String? vin,@VehicleCalibrationModeJsonConverter() VehicleCalibrationMode calibrationMode, bool autoRecord, double movementStartThresholdKmh, int disconnectSaveDelaySec, bool backgroundLocationConsent, String? make, String? model, int? year, String? referenceVehicleId, TripLengthBreakdown? tripLengthAggregates, SpeedConsumptionHistogram? speedConsumptionAggregates, DateTime? aggregatesUpdatedAt, int? aggregatesTripCount, double tireCircumferenceMeters, List<double>? gearCentroids, String? lastReadVin, DateTime? lastVinReadAt, String? detectedMake, String? detectedModel, int? detectedYear, int? detectedEngineDisplacementCc, String? detectedFuelType, GpsCalibrationMatrix? gpsCalibration
});
...
class _VehicleProfile extends VehicleProfile {
  const _VehicleProfile({required this.id, required this.name, @VehicleTypeJsonConverter() this.type = VehicleType.combustion, this.batteryKwh, this.maxChargingKw, @ConnectorTypeSetConverter() final  Set<ConnectorType> supportedConnectors = const <ConnectorType>{}, @ChargingPreferencesJsonConverter() this.chargingPreferences = const ChargingPreferences(), this.tankCapacityL, this.preferredFuelType, this.engineDisplacementCc, this.engineCylinders, this.volumetricEfficiency = 0.85, this.volumetricEfficiencySamples = 0, this.manualEngineDisplacementCcOverride, this.manualVolumetricEfficiencyOverride, this.manualAfrOverride, this.manualFuelDensityGPerLOverride, this.curbWeightKg, this.obd2AdapterMac, this.obd2AdapterName, this.vin, @VehicleCalibrationModeJsonConverter() this.calibrationMode = VehicleCalibrationMode.rule, this.autoRecord = false, this.movementStartThresholdKmh = 5.0, this.disconnectSaveDelaySec = 60, this.backgroundLocationConsent = false, this.make, this.model, this.year, this.referenceVehicleId, this.tripLengthAggregates, this.speedConsumptionAggregates, this.aggregatesUpdatedAt, this.aggregatesTripCount, this.tireCircumferenceMeters = 1.95, final  List<double>? gearCentroids, this.lastReadVin, this.lastVinReadAt, this.detectedMake, this.detectedModel, this.detectedYear, this.detectedEngineDisplacementCc, this.detectedFuelType, this.gpsCalibration}): _supportedConnectors = supportedConnectors,_gearCentroids = gearCentroids,super._();
