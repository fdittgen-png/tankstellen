...
/// power-agnostic path.
 int? get powerKw;/// Nominal fuel-tank capacity in litres for this generation (#3651).
///
...
/// catalog-reset consumers simply leave the profile field alone.
 double? get tankCapacityL;/// One of "petrol", "diesel", "hybrid", "electric". Stored as a
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,make,model,generation,yearStart,yearEnd,displacementCc,powerKw,tankCapacityL,fuelType,transmission,volumetricEfficiency,odometerPidStrategy,inductionType,directInjection,atkinsonCycle,notes);

@override
String toString() {
  return 'ReferenceVehicle(make: $make, model: $model, generation: $generation, yearStart: $yearStart, yearEnd: $yearEnd, displacementCc: $displacementCc, powerKw: $powerKw, tankCapacityL: $tankCapacityL, fuelType: $fuelType, transmission: $transmission, volumetricEfficiency: $volumetricEfficiency, odometerPidStrategy: $odometerPidStrategy, inductionType: $inductionType, directInjection: $directInjection, atkinsonCycle: $atkinsonCycle, notes: $notes)';
}
...
@useResult
$Res call({
 String make, String model, String generation, int yearStart, int? yearEnd, int displacementCc, int? powerKw, double? tankCapacityL, String fuelType, String transmission, double volumetricEfficiency, String odometerPidStrategy, InductionType inductionType, bool directInjection, bool atkinsonCycle, String? notes
});
...
/// Create a copy of ReferenceVehicle
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? make = null,Object? model = null,Object? generation = null,Object? yearStart = null,Object? yearEnd = freezed,Object? displacementCc = null,Object? powerKw = freezed,Object? tankCapacityL = freezed,Object? fuelType = null,Object? transmission = null,Object? volumetricEfficiency = null,Object? odometerPidStrategy = null,Object? inductionType = null,Object? directInjection = null,Object? atkinsonCycle = null,Object? notes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String make,  String model,  String generation,  int yearStart,  int? yearEnd,  int displacementCc,  int? powerKw,  double? tankCapacityL,  String fuelType,  String transmission,  double volumetricEfficiency,  String odometerPidStrategy,  InductionType inductionType,  bool directInjection,  bool atkinsonCycle,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReferenceVehicle() when $default != null:
return $default(_that.make,_that.model,_that.generation,_that.yearStart,_that.yearEnd,_that.displacementCc,_that.powerKw,_that.tankCapacityL,_that.fuelType,_that.transmission,_that.volumetricEfficiency,_that.odometerPidStrategy,_that.inductionType,_that.directInjection,_that.atkinsonCycle,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String make,  String model,  String generation,  int yearStart,  int? yearEnd,  int displacementCc,  int? powerKw,  double? tankCapacityL,  String fuelType,  String transmission,  double volumetricEfficiency,  String odometerPidStrategy,  InductionType inductionType,  bool directInjection,  bool atkinsonCycle,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _ReferenceVehicle():
return $default(_that.make,_that.model,_that.generation,_that.yearStart,_that.yearEnd,_that.displacementCc,_that.powerKw,_that.tankCapacityL,_that.fuelType,_that.transmission,_that.volumetricEfficiency,_that.odometerPidStrategy,_that.inductionType,_that.directInjection,_that.atkinsonCycle,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String make,  String model,  String generation,  int yearStart,  int? yearEnd,  int displacementCc,  int? powerKw,  double? tankCapacityL,  String fuelType,  String transmission,  double volumetricEfficiency,  String odometerPidStrategy,  InductionType inductionType,  bool directInjection,  bool atkinsonCycle,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _ReferenceVehicle() when $default != null:
return $default(_that.make,_that.model,_that.generation,_that.yearStart,_that.yearEnd,_that.displacementCc,_that.powerKw,_that.tankCapacityL,_that.fuelType,_that.transmission,_that.volumetricEfficiency,_that.odometerPidStrategy,_that.inductionType,_that.directInjection,_that.atkinsonCycle,_that.notes);case _:
  return null;
...
/// Create a copy of ReferenceVehicle
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? make = null,Object? model = null,Object? generation = null,Object? yearStart = null,Object? yearEnd = freezed,Object? displacementCc = null,Object? powerKw = freezed,Object? tankCapacityL = freezed,Object? fuelType = null,Object? transmission = null,Object? volumetricEfficiency = null,Object? odometerPidStrategy = null,Object? inductionType = null,Object? directInjection = null,Object? atkinsonCycle = null,Object? notes = freezed,}) {
