...
/// rendered at the bottom of the Link Device screen. Thin binding over
/// the shared [InfoCard] skeleton.
///
...
class LinkDeviceHowItWorksCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InfoCard(
      ...
      title: l10n.linkDeviceHowItWorksTitle,
      body: l10n.linkDeviceHowItWorksBody,
    );
  }
}
