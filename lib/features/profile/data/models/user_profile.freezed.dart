...
/// state.
@Deprecated('Migrated to Feature.showConsumptionTab in #1373 phase 3c; kept for one-shot migration read.') bool get showConsumptionTab;/// REMOVED (#4252) — gamification is gone from the app. The field
...
@Deprecated('Gamification was removed in #4252. Kept only so stored profiles decode; nothing reads it.') bool get gamificationEnabled;/// Radius (in km) within which the in-trip approach overlay
...
/// evaluation continues to run so toggling back on instantly
/// restores any earned badges.
@override@JsonKey()@Deprecated('Gamification was removed in #4252. Kept only so stored profiles decode; nothing reads it.') final  bool gamificationEnabled;
