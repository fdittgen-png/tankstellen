...
/// behaviour change.
 double get routeDetourBudgetKm;@Deprecated('Migrated to Feature.showFuel in #1373 phase 3c; kept for one-shot migration read.') bool get showFuel;@Deprecated('Migrated to Feature.showElectric in #1373 phase 3c; kept for one-shot migration read.') bool get showElectric;/// Rating sharing mode:
...
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.name,_that.preferredFuelType,_that.defaultSearchRadius,_that.landingScreen,_that.favoriteStationIds,_that.homeZipCode,_that.autoUpdatePosition,_that.countryCode,_that.languageCode,_that.routeSegmentKm,_that.avoidHighways,_that.routeDetourBudgetKm,_that.showFuel,_that.showElectric,_that.ratingMode,_that.preferredAmenities,_that.defaultVehicleId,_that.hybridFuelChoice,_that.showConsumptionTab,_that.gamificationEnabled);case _:
  return orElse();
