...
// sync-transparent (no Supabase schema change).
 int? get enginePowerKw; double get volumetricEfficiency; int get volumetricEfficiencySamples;// User-editable calibration overrides (#1397). Each is null until
...
as int,manualEngineDisplacementCcOverride: freezed == manualEngineDisplacementCcOverride ? _self.manualEngineDisplacementCcOverride : manualEngineDisplacementCcOverride // ignore: cast_nullable_to_non_nullable
