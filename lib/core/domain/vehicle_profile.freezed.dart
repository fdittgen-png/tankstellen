...
// JSONB-stored field-add — sync-transparent.
 double get pumpGain; int get pumpGainSamples; DateTime? get pumpGainUpdatedAt;// User-editable calibration overrides (#1397). Each is null until
...
as DateTime?,manualEngineDisplacementCcOverride: freezed == manualEngineDisplacementCcOverride ? _self.manualEngineDisplacementCcOverride : manualEngineDisplacementCcOverride // ignore: cast_nullable_to_non_nullable
