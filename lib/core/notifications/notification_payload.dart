...
class NotificationPayload {
  ...
  static NotificationPayload? tryDecode(String? raw) {
    ...
    // #4070 — the dispatcher namespaces payloads now, so everything that
    // reaches this decoder is addressed to it: a parse failure here is a
    // genuine fault and is logged (the #4054 shape guard is gone with it).
    try {
