...
|---|---|---|---|
| `no_raw_card_in_widgets_test.dart` | raw `Card(` → `PrimaryCard` / `PanelCard` | widgets | 46 (#3995) |
| `no_inline_title_theme_in_widgets_test.dart` | `textTheme.title*` / `headlineSmall` → `AppText` role or `SectionHeader` | widgets | 89 (#3995) |
| `no_hard_font_size_test.dart` | `fontSize:` → a type role (scales with the text-size setting) | screens + widgets | 76 (#3995) |
